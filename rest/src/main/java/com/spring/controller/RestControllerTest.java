...
public class RestControllerTest {
	...
	// 일반 컨트롤러에서 return 값 view 이름(jsp..) return을 하지 않아도 경로를 찾는데 쓰였다
	// Rest 컨트롤러에서 return 값은 데이터(String..) 문자열 리턴됨
	@GetMapping("/hello")
	...
	// 자바 객체 ==> json 형태로 변경해주는 라이브러리가 필요함 - Jackson Databind
	...
	// ResponseEntity : 상태코드(200,400,500) - http 의 상태코드와 데이터 같이 전송
