...
// 이벤트 전파 : 자식의 이벤트는 부모에게 전달 됨 => ul 에 이벤트
chat.addEventListener("click", (e) => {
  // 어느 li에서 이벤트가 발생했느냐?
  // e.target : 이벤트 발생 대상
  // 이벤트 발생 대상을 감싸고 있는 부모 li 찾기 : closest함수
  ...
  // 이벤트를 부모가 감지를 하기 때문에 - 수정버튼 클릭 시만 모달을 띄워줘
