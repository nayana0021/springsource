...
public class SecurityConfig {
	...
	@Bean
	public UserDetailsService customUserService() { //@Service("detail") 과 같은 역할 (CustomUserDetailService.java)
	...
	@Bean
	protected SecurityFilterChain configure(HttpSecurity http) throws Exception {	// <security:http> 해당
