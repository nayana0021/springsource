 ...
 <div class="row">
 	<div class="col">
		<form action="" method="post">
		  ...
		  <%-- 로그인 상황에서 해당 게시물 작성자와 동일할 때만 보여주기(수정버튼) --%>
		  <security:authorize access="isAuthenticated()"> <%-- 인증된 사용자만 접근하도록 설정 --%>
			  	<security:authentication property="principal.username" var="username"/> <%-- 현재 사용자의 인증 객체에 username 속성을 가져와 username 이라는 변수에 저장, principle은 현재 인증된 사용자를 나타내는 객체를 의미 --%>
