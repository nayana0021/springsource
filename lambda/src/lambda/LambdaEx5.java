...
public class LambdaEx5 {
	public static void main(String[] args) {
		...
		Supplier<Integer> s = () -> (int)(Math.random() * 100)+1; // 지네릭스 들어오는 타입은 object ( 대문자로 시작하는 것들)
		...
		System.out.println(f.apply(561)); // 1의 자리 제거
	}
}
