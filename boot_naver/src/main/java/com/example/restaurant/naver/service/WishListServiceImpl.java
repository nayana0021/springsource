...
public class WishListServiceImpl implements WishListService {
	...
	private WishListEntity dtoToEntity(WishListDTO wishListDTO) {	//데이터베이스 저장
		// dto => entity 객체로
	...
	private WishListDTO entityToDto(WishListEntity entity) {	//화면단에 띄워줄 용도
		// entity => dto 객체로
		WishListDTO dto = new WishListDTO();
	...
	@Override	//작업이 끝나고 데이터가 엔티티로 넘어옴 -> DTO로 바꿔야 함
