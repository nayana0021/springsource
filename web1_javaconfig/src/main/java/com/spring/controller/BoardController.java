...
//	@RequestMapping(value="/register", method = RequestMethod.GET)
	...
	// Model == request.setAttribute() 와 같은 개념
	// RedirectAttributes : 
	// 1) addAttribute() - 일회성으로 데이터를 전달(객체 상태로 값 전달 불가 - 주소줄에 따라가는 방식이므로)
...
//		
//		// board/read?name=홍길동&password=hong123&title=글글&content=게시글1
...
////		//addAttribute 를 사용하게 되면 주소줄에 따라간다
//		
